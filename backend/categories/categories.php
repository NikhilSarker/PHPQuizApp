...
$checking_query = " SELECT * FROM `categories` ORDER BY category_name ASC";
...
<div id="main">
  ...
  <table border="1">
    ...
    <?php while ($record = mysqli_fetch_assoc($checking_query_to_db)) : ?>
      <tr>
        ...
        <td class="text-center"><a href="categories_edit.php?id=<?= $record['id']; ?>" class=" btn btn-info">Edit</a></td>
  ...
  <p class="add_btn"><a href="categories_add.php"><i class="fas fa-plus-square"></i> Add Category</a></p>
    ...
    deleteBtn.addEventListener("click", function () {
      ...
      Swal.fire({
        ...
        if (result.isConfirmed) {
          window.location.href = `categories_delete.php?id=${deleteBtn.value}`;
